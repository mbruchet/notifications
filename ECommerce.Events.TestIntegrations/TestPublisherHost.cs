...
using ECommerce.Events.Sample.RemotePublisher;
...
{
    internal class TestPublisherHost
    {
        public TestServer Server { get; }

        public TestPublisherHost()
        {
            var applicationBasePath = Path.GetFullPath(Path.Combine(Directory.GetCurrentDirectory(), @"..\..\..\..\ECommerce.Events.Sample.RemotePublisher"));
